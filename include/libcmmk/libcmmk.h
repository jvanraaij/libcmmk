...
enum cmmk_effect_id {
	...
	CMMK_EFFECT_SINGLE = 0x02,
	CMMK_EFFECT_WAVE = 0x03,
	CMMK_EFFECT_RIPPLE = 0x04,
	CMMK_EFFECT_CROSS = 0x05,
	CMMK_EFFECT_RAINDROPS = 0x06,
	CMMK_EFFECT_STARS = 0x07,
	CMMK_EFFECT_SNAKE = 0x08,
	CMMK_EFFECT_CUSTOMIZED = 0x09,
	CMMK_EFFECT_MULTILAYER = 0xe0,
	CMMK_EFFECT_OFF = 0xfe
};
/* unsupported mode, define left for compatiblity reasons */
#define CMMK_EFFECT_CYCLE CMMK_EFFECT_OFF
